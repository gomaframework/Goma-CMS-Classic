...
class RegisterExtension extends ControllerExtension
{
	 ...
	 * @name extra_methods
	 */
	protected static $extra_methods = array("register", "doRegister", "resendActivation", "activate");
	...
	public function register()
	{
		...
		if (isset(Member::$loggedIn)) {
			...
			return ViewAccessableData::instance()->renderWith("profile/registerNotAllowed.html");
		} else {
			$user = new User();
