...
interface postArgumentsSearchQuery {
	/**
	 * @param SelectQuery $query
	 * @param string|array $searchQuery
	 * @param string $version
	 ...
	 * @param bool $forceClasses if to only get objects of this type of every object from the table
	 */
	public function postArgumentSearchSQL($query, $searchQuery, $version, $filter, $sort, $limit, $join, $forceClasses);
}
